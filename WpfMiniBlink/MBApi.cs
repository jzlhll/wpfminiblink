...
namespace Miniblink
{
    internal class MBApi
    {
        ...
        [DllImport(DLL_x86, EntryPoint = "jsDeleteObjectProp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        private static extern void jsDeleteObjectProp_x86(IntPtr es, Int64 jsValue, string prop);
        [DllImport(DLL_x64, EntryPoint = "jsDeleteObjectProp", CallingConvention = CallingConvention.Cdecl)]
        private static extern void jsDeleteObjectProp_x64(IntPtr es, Int64 jsValue, string prop);

        public static void jsDeleteObjectProp(IntPtr es, Int64 jsValue, string prop)
        {
            if (is64())
            {
                jsDeleteObjectProp_x64(es, jsValue, prop);
            }
            else
            {
                jsDeleteObjectProp_x86(es, jsValue, prop);
            }
        }
        ...
        public static extern long wkeRunJsByFrame_x86(IntPtr webView, IntPtr frameId, [MarshalAs(UnmanagedType.LPArray)]byte[] script,
    [MarshalAs(UnmanagedType.I1)]bool isInClosure);
        ...
        public static extern long wkeRunJsByFrame_x64(IntPtr webView, IntPtr frameId, [MarshalAs(UnmanagedType.LPArray)]byte[] script, 
            [MarshalAs(UnmanagedType.I1)]bool isInClosure);

        public static long wkeRunJsByFrame(IntPtr webView, IntPtr frameId, byte[] str, bool isInClosure)
        {
            return is64() ? 
