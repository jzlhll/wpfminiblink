...
namespace WpfMiniBlink
{
    public class MiniblinkBrowser : Border, IMiniblink, INotifyPropertyChanged
    {
        ...
        public event EventHandler<LoadUrlEndArgs> LoadUrlEndEx;
        ...
        public static void NetHookRequest(IntPtr ptr) {
            MBApi.wkeNetHookRequest(ptr);
        }
        ...
        protected virtual bool OnLoadUrlEnd(IntPtr mb, IntPtr job, byte[] data = null)
        {
            ...
            if (begin != null)
            {
                ...
                if (LoadUrlEndEx != null) {
                    LoadUrlEndEx.Invoke(this, end);
                }
        ...
        public JsValue RunJsByFrame(IntPtr FrameId, string JavaScript, bool IsInClosure = false)
        {
            ...
            return MBApi.wkeRunJsByFrame(MiniblinkHandle, FrameId, utf8, IsInClosure);
        }
        ...
        {
            return MBApi.wkeGlobalExec(MiniblinkHandle);
        }
